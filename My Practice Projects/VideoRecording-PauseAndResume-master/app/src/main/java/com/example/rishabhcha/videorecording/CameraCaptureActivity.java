...
import com.example.rishabhcha.videorecording.ui.MainActivity;
...
public class CameraCaptureActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LinearLayout tagsx=(LinearLayout)findViewById(R.id.tags);
        ...
        mCaptureButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isFirstClick){
                    ...
                    mCaptureButton.setBackgroundResource(R.drawable.ic_fiber_manual);
                    chronometer.start();
                    start_recording();
                    isFirstClick = false;
                    ...
                    if(!recording){
                        ...
                        recording=true;
                        mCaptureButton.setBackgroundResource(R.drawable.ic_fiber_manual);
                        tagsx.setVisibility(View.GONE);
                        tag_btn.setVisibility(View.GONE);
                     }else{
                        ...
                        recording=false;
                        mCaptureButton.setBackgroundResource(R.drawable.capture_photo_button);
                        tag_btn.setVisibility(View.VISIBLE);
                        tagsx.setVisibility(View.VISIBLE);
                    }
       ...
       final EditText tag_text=(EditText)findViewById(R.id.tag_text);
        ...
        tag_list.setAdapter(arrayAdapter);
        ...
        tag_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tags.add(tag_text.getText().toString());
                tag_text.setText("");
                 /*
...
//        }
    ...
    public void OnSubmit(View view) {
      ...
      //  Intent intent = new Intent();
      //  intent.putExtra("video", Environment.getExternalStorageDirectory() + "/test.mp4");
      //  intent.setClass(CameraCaptureActivity.this, MainActivity.class);
